...
import type { PaymentMethodDraft } from "../../domain/events/reference";
import { paymentMethodCreated } from "../../domain/events/reference";
 ...
 * num teste que os cinco eventos nascem com HLCs distintos e crescentes — a
 * garantia que impede alguém contornar o relógio montando envelopes na mão.
 *
 * O perfil vem antes dos métodos porque um lote interrompido não pode deixar
 * métodos existindo sem o perfil que os semeou. Na prática a escrita é atômica e
 * nunca chega interrompida; a ordem é a segunda linha de defesa.
 */
